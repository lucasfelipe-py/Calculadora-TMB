...
taxa_1 = Radiobutton(frame_baixo, text='Sedentário (pouco ou nenhum exercício)', font='Ivy 10', value='1.2', variable=entrada_taxas)
taxa_1.grid(row=1, column=0, sticky=NSEW, pady=1, padx=35)

taxa_2 = Radiobutton(frame_baixo, text='Levemente ativo (exercício leve - 1 a 3 dias por semana)', font='Ivy 10', value='1.375', variable=entrada_taxas)
taxa_2.grid(row=2, column=0, sticky=NSEW, pady=1, padx=35)

taxa_3 = Radiobutton(frame_baixo, text='Moderadamente ativo (exercício moderado - 3 a 5 dias por semana)', font='Ivy 10', value='1.55', variable=entrada_taxas)
taxa_3.grid(row=3, column=0, sticky=NSEW, pady=1, padx=35)

taxa_4 = Radiobutton(frame_baixo, text='Muito ativo (exercício pesado - 5 a 6 dias por semana)', font='Ivy 10', value='1.725', variable=entrada_taxas)
taxa_4.grid(row=4, column=0, sticky=NSEW, pady=1, padx=35)

taxa_5 = Radiobutton(frame_baixo, text='Extremamente ativo (exercício pesado diariamente e até 2 vezes por dia)', font='Ivy 10', value='1.9', variable=entrada_taxas)
...
def calcular():
    ...
    taxa_atividade = float(entrada_taxas.get())
